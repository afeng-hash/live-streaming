...
public class NacosDriverURLProvider implements ShardingSphereDriverURLProvider {
     ...
     * (jdbc:shardingsphere:nacos:afeng.nacos.com:8848:afeng-live-user-shardingjdbc.yaml?username=afeng&&password=afeng&&namespace=afeng-live-test）
     * @return
     */
    @Override
     ...
     *
     * @param url （jdbc:shardingsphere:nacos:afeng.nacos.com:8848:afeng-live-user-shardingjdbc.yaml?username=afeng&&password=afeng&&namespace=afeng-live-test）
     * @return
     */
    @Override
    public byte[] getContent(final String url) {
        ...
        //得到例如：afeng.nacos.com:8848:afeng-live-user-shardingjdbc.yaml?username=afeng&&password=afeng&&namespace=afeng-live-test 格式的url
        String nacosUrl = url.substring(url.lastIndexOf(NACOS_TYPE) + NACOS_TYPE.length());
        /**
         * 得到三个字符串，分别是：
         * afeng.nacos.com
         * 8848
         * afeng-live-user-shardingjdbc.yaml
         */
         ...
         * 得到两个字符串
         * afeng-live-user-shardingjdbc.yaml
         * username=afeng&&password=afeng&&namespace=afeng-live-test
         */
