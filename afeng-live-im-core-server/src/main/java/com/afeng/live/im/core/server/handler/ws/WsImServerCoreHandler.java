package com.afeng.live.im.core.server.handler.ws;

import com.afeng.live.im.core.server.common.ImMsg;
import com.afeng.live.im.core.server.handler.ImHandlerFactory;
import com.afeng.live.im.core.server.handler.impl.LogoutMsgHandler;
...
public class WsImServerCoreHandler extends SimpleChannelInboundHandler {
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        if (userId != null && appId != null) {
            logoutMsgHandler.logoutHandler(ctx,userId,appId,ImContextUtils.getRoomId(ctx));
        }
    }
