...
public class ImHandlerFactoryImpl implements ImHandlerFactory , InitializingBean {
    ...
    @Override
    public void doMsgHandler(ChannelHandlerContext ctx, ImMsg msg) throws IllegalAccessException {
        SimplyHandler simplyHandler = simplyHandlerMap.get(msg.getCode());
