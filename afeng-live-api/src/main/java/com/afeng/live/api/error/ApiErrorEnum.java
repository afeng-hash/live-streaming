package com.afeng.live.api.error;

import com.afeng.live.web.starter.constants.ErrorAppIdEnum;
import com.afeng.live.web.starter.error.AfengBaseError;

public enum ApiErrorEnum implements AfengBaseError {
    ...
    public int getErrorCode() {
        return Integer.parseInt(ErrorAppIdEnum.AFENG_API_ERROR.getCode() + "" + errorCode);
    }
