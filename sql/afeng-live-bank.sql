...
-- Create syntax for TABLE 't_afeng_currency_account'
CREATE TABLE `t_afeng_currency_account` (
  `user_id` bigint unsigned NOT NULL COMMENT '用户id',
...
-- Create syntax for TABLE 't_afeng_currency_trade'
CREATE TABLE `t_afeng_currency_trade` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
